...
Tidy-data / normal-forms help reduce duplication
...
m %>%
  ...
  tidyr::gather(key = "sample_id", value = "value", -feature_id) %>%
  head()
```
...
<!-- 
    ...
    - Have to keep track of multiple data-frames, rather than one
      data-structure
    - Only real benefit of the multiple data-frame structure is ease of summary
      / plotting approaches in dplyr / ggplot
-->
